...
class StorePropertyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'listing_status' => ['required', 'string', Rule::in([
    ...
    public function messages(): array
    {
        return [
            ...
            'project_id.required' => 'Please select a project for this property.',
            'project_id.exists' => 'The selected project does not exist.',
            'property_type.required' => 'Please select a property type.',
            'listing_status.required' => 'Please select a listing status.',
    ...
    public function attributes(): array
    {
        return [
            ...
            'floor_area_unit' => 'floor area unit',
