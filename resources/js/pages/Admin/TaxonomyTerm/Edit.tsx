...
export default function Edit({ term, taxonomies }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        taxonomy_id: term.taxonomy_id.toString(),
        name: term.name,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/taxonomy-terms/${term.id}`);
    };
        ...
        <AdminLayout>
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Edit Taxonomy Term</h1>
                        <p className="text-muted-foreground">Update term information</p>
                    </div>
                    <Link href={`/admin/taxonomy-terms?taxonomy_id=${term.taxonomy_id}`}>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Editing: <strong>{term.name}</strong>
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="bg-muted rounded p-3">
                                    <code className="text-sm">{term.slug}</code>
                                </div>
