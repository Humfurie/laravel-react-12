...
export default function Edit({ expertise, categories }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(
            route('admin.expertises.update', expertise.id),
            {
                ...data,
                _method: 'PUT',
            },
    ...
    return (
        <AdminLayout>
            <Head title={`Edit ${expertise.name}`} />
            ...
            <div className="mx-auto max-w-3xl space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Edit Expertise</h1>
                        <p className="text-muted-foreground mt-2">Update expertise details</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Update the information about this expertise</CardDescription>
                        </CardHeader>
                    ...
                    <div className="mt-6 flex items-center justify-end gap-4">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Updating...' : 'Update Expertise'}
                        </Button>
                    </div>
                </form>
            </div>
