...
function WinnerCard({ raffle }: { raffle: Raffle }) {
    return (
            ...
            <CardContent className="p-6">
                ...
                <div className="mb-4 flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="font-semibold">{raffle.winner.name}</p>
                    </div>
                </div>
                ...
                <div className="text-muted-foreground flex items-center gap-4 border-t pt-3 text-sm">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <span>Ended {formatDistanceToNow(new Date(raffle.end_date), { addSuffix: true })}</span>
                    </div>
                </div>
            </CardContent>
        </Card>
...
export default function Winners({ raffles }: Props) {
    return (
        <>
            <Head title="Raffle Winners" />
            ...
            <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white">
                <div className="container mx-auto px-4 py-12">
                    ...
                    <div className="mb-12 text-center">
                        ...
                        <h1 className="mb-4 text-4xl font-bold md:text-5xl">Past Winners</h1>
                        <p className="text-muted-foreground mx-auto max-w-2xl text-lg">
                            Congratulations to all our lucky winners! View the history of our completed raffles and their champions.
                        </p>
                    </div>
                    ...
                    {raffles.length === 0 ? (
                        <div className="flex min-h-[400px] flex-col items-center justify-center rounded-lg border border-dashed p-8 text-center">
                            ...
                            <p className="text-muted-foreground mb-4">No raffles have been completed yet. Check back soon!</p>
                            <Link href="/raffles">
                                <Button>View Active Raffles</Button>
                            </Link>
                        </div>
                    ) : (
                        <>
                            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                                {raffles.map((raffle) => (
                                    <WinnerCard key={raffle.id} raffle={raffle} />
                                ))}
                            </div>
